...
public class RatingController extends SessionController{
	...
	public HashMap<String,String> ReturnAverageOfRating(HashMap<String,HashMap<Integer,Integer>> hasmap){
		HashMap<String,String> ProAverage = new HashMap<String, String>();
		for (String index : hasmap.keySet()){
	...
	private String ReturnAverage(HashMap<Integer,Integer> hasmap){
		int tmpRating=0;
		int count=0;
		...
		return ReturnFormatted((double)tmpRating/count);
		
	}
	
	private String ReturnFormatted(double value){
